...
@Component({
  selector: 'app-admin-lista-ficha-preprensa',
  templateUrl: './admin-lista-ficha-preprensa.component.html',
  styleUrls: ['./admin-lista-ficha-preprensa.component.css']
})
...
export class AdminListaFichasPreprensaComponent implements OnInit {
